...
<body>
    <div class="container">
        <br>
        <div class="row">
            <h2 style="text-align:center; font-family: monospace; font-weight: bolder;">REGISTRO DE PERSONAS</h2>
        </div>
        <div class="row">
    ...
    <!-- Modal -->
    <div class="modal fade" id="confirm-delete" tabindex="-1" role="dialog" arialabelledby="myModalLabel"
        aria-hidden="true">
